...
public abstract class Item implements SerializadoIF {
	...
	/**
	 * @return O código de Hash de um item
	 * */
	@Override
	public int hashCode() {
		final int prime = 31;
	...
	/**
	* Testa a igualdade de um objeto com este item. 
	...
	*/	
	...
	/**
	 * @param estado - novo estado do item
	 */
	...
	/**
	 * @param precoDeCompra - novo preço de compra do item
	 */
	...
	/**
	 * Recupera o número de vezes dos emprestimos
	...
	/**
	 * @param nivel - novo nível de importancia
	 */
