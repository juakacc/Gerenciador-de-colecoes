...
/**
 * Classe que funciona como um repositório que serve para
 * armazenar as Sagas que o usuário cadastrar
 * 
...
public class RepositorioSaga {
	...
	public void verSaga(String nome) {
		...
		try {
			List<Saga> lista = this.getSaga(nome);
	...
	/**
	 * @return O total de sagas cadastradas pelo usuário
	 * */
