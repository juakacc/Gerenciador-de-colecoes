...
/**
 * Recupera o estado do sistema de onde o usuário
 * parou da última vez que o acessou.
 * */
	...
	private void recuparItensEmprestados() {
		...
		try {
			...
			while ((line = r.readLine()) != null) {
				...
				emprestados.adicionarItemDaPersistencia(new ItemEmprestado(item, amigo, dataDoEmprestimo, dataDaEntrega));
			}
		} catch (Exception e) {
