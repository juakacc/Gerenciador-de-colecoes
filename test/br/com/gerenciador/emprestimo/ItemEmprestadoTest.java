...
public class ItemEmprestadoTest {
	...
	public void testImprimir() {
		...
		str.append(jogo.imprimirParaArquivo() + "\n");
		str.append(amigo.imprimirParaArquivo() + "\n");
		str.append(item.getDataDoEmprestimo().getTimeInMillis() + "\n");
		str.append(item.getDataDaEntrega().getTimeInMillis());
